#
#  Be sure to run `pod spec lint SNScanViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
  Scanning view controllers using AVFoundation
                   DESC

  s.homepage     = "https://github.com/snlo/SNScanViewController"
  ...
  s.source       = { :git => "https://github.com/snlo/SNScanViewController.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "SNScanViewController/SNScanViewController/*.{h,m}"
